...
eee = {e'8 fis' g'4\prall 8 e' g' fis'4\prall 8 d' |a'4    g'   g'8   e' g' fis'4\prall 8 d' | 
       e'8 fis' g'4\prall 8 e' g' fis'4\prall 8 d'        |}
...
voice_part_e = \fixed c' { 
   ...
   \repeat volta 2 { \eee } 
   \alternative {
      { e'8 d' cis' d' e'4\prall a'8    e'4 4 |}
      { e'8 d' cis' d' e'2.\fermata a'16    e'16 |}
   }
   \break
}
