...
voice_vocal_a = \fixed c' { 
  ...
  \repeat volta 2 {
    a a a4 \triole{a8 bes c'} \triole{bes a g} 
    a a fis4 r8 d fis g a4
    r8 d'~ \triole{d'8 a c'} \triole{bes a g} 
    a8 a fis4 r8 d fis g a g bes a g fis es d g g c4
    r8 c es g 
...
voice_vocal_b = \fixed c' { 
  \repeat volta 2 {
    \mark #2 cis'8 d'4 d'8 d'16 cis' bes8 bes4 a16 c' bes8 bes bes 
    a8. \startTrillSpan g16 \stopTrillSpan fis8 g fis g a bes c' a16 c' 
    \triole{bes8 a g} a2  r8  d g  bes \break
...
voice_vocal_c = \fixed c' { 
  \repeat volta 2 {
    \set Score.currentBarNumber = #46
     \mark #3 d8 r8 r4^\straigt d8 r^\straigt \triole{bes8 a g} 
