...
voice_vocal_a = \fixed c' { 
  ...
  \repeat volta 2 {
    ...
    fis g_\markup{\italic"end Intro" \raise #0.55 \musicglyph "arrowheads.close.01" "|" } a g fis es d c  
...
voice_vocal_c = \fixed c' { 
  \repeat volta 2 {
    \set Score.currentBarNumber = #44
     \mark #3 d8\accent r8 r4 bes8\accent r \triole{bes8 a g} 
     \triole{fis8 g a} \triole{g8 fis es}   fis8 g gis a d8\accent r r4|
     d8\accent r \triole{bes8 a g} \triole{fis8 g a} \triole{bes a g}  
     \triole{a g fis} \triole{es d c } 
     d8\accent r8 r4 d8\accent r \triole{bes8 a g} fis8 g gis a   
     bes8 c'4.~\p\<  c'2~ c'2~ c'2\!\f
